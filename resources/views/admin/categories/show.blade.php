    ...
    <div ng-app="treeApp" ng-controller="treeCtrl">
        ...
        <section class="content-header">
            ...
            <div class="btns-panel">
                <a href="categories/create" class="btn btn-success" title="Добавить" data-toggle="tooltip" data-placement="bottom">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				...
				<span class="label label-success" style="margin-left: 0!important;">Всего {{$count_categories}} {{ Lang::choice('категория|категории|категорий', $count_categories , array(), 'ru') }}</span>
				&nbsp
			...
			<div class="panel-body">
	            @if( $count_categories > 0 )
                    ...
                    <script type="text/ng-template" id="nodes_renderer.html">
                        <div class="tree-node">
                            ...
                            <div class="tree-node-content">
                                ...
                                <a class="black_link"
                                   href="/master/categories/edit/[[node.id]]">[[node.name]]</a>
                                <div class="pull-right">
                                    <a title="Edit" href="/master/categories/edit/[[node.id]]"
                    ...
                    <div ui-tree="dataOptions" data-max-depth="3" id="tree-root">
