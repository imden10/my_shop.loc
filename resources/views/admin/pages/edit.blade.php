...
@section('main')
    ...
    {!! Form::model($page, ['route'=> ['pages-update'], 'class' => 'form-horizontal', 'role' => 'form', 'files' => true ] ) !!}
    {!! csrf_field() !!}
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tab_main">
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10 col-sm-10 col-xs-12">
                                    <input type="checkbox" ng-checked="data.active" value="1" name="active" id="active" class="form-control styler">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="thumbnail" style="display: block; width: 15%; vertical-align: top; margin-top: 20px" ng-hide="data.image == 'default.jpg'">
                                        <img style="width: 100%;" alt="photo" src="/uploads/pages/[[data.image]]"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    {!! Form::textarea('desc', '[[data.desc]]', array('class'=>'form-control editor') ) !!}
                    ...
                    <div class="tab-pane" id="tab_seo">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputMetaKeys" name="meta_keywords" value="[[data.meta_keywords]]">
                            </div>
                        </div>
                        <div class="form-group">
